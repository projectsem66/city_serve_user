                                                            ...
                                                            color: documentSnapshot
                                                                ...
                                                                : documentSnapshot.get(
                                                                    ...
                                                                    : documentSnapshot.get("status") ==
                                                                        ...
                                                                        : documentSnapshot.get("status") ==
                                                                                "In Progress"
                                                                            ? AppColors.jetBlue.withOpacity(0.2)
                                                                            : documentSnapshot.get("status") == "is Done?"
                                                              ...
                                                              color: documentSnapshot
                                                                  ...
                                                                  : documentSnapshot.get("status") ==
                                                                      ...
                                                                      : documentSnapshot.get("status") ==
                                                                          ...
                                                                          ? AppColors
                                                                              .lightGreen
                                                                          : documentSnapshot.get("status") == "In Progress"
                                                                              ? AppColors.jetBlue
                                                                              : documentSnapshot.get("status") == "is Done?"
                                                                                  ? Colors.orange
                                                                                  : documentSnapshot.get("status") == "Completed"
                                                            ...
                                                            child: Text(
                                                              documentSnapshot
                                                                  .get(
                                                                      "status"),
                                                              style: GoogleFonts.poppins(
                                                                  color: documentSnapshot.get("status") == "Pending"
                                                                      ? AppColors.red
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            "₹${documentSnapshot.get("totalPrice")}",
                                                            style: GoogleFonts.poppins(
                                                                color: AppColors
                                                                    .Colorq,
                                                                fontSize:
